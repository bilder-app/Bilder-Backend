export const businesses: any = [
  {
    business: {
      ...
      products: [
        ...
        {
          name: "Weber Classic 25kg (nieve)",
          description:
            "Pastina para tomar juntas de hasta 5mm entre cerámicas de alta absorción, tanto en pisos como paredes.",
          price: 2250,
          stock: 150,
          content: 25,
          contentType: "Kilo (k)",
          images: [
            "https://http2.mlstatic.com/D_NQ_NP_847145-MLA44402110324_122020-O.webp",
          ],
        },
        {
          name: "Disco De Corte Tyrolit 4,5",
          description:
            "Disco De Corte Tyrolit 4,5 PuLG 114 X 1.6 X 22.23 Pack de 10 unidades ",
          price: 1500,
          stock: 50,
          brand: "Tyrolit",
          content: 10,
          ...
          images: [
            "https://http2.mlstatic.com/D_NQ_NP_749188-MLA44403481864_122020-O.webp",
          ],
        },
        {
          name: "Clavo Punta Paris De 2 X Kg Galeria",
          description: "Clavo Punta Paris De 2 precio x Kilogramo",
          price: 600,
          stock: 100,
          content: 2,
          brand: "Acindar",
        ...
        {
          name: "Varilla De Hierro Aletado 16 Mm Construccion",
          description:
            "Barras de Acero de Dureza Natural ADN-420-Normal, para estructuras de hormigón armado",
          price: 600,
          stock: 100,
          content: 12,
          brand: "Gerdau",
          contentType: "Metro (m)",
          images: [
            "https://http2.mlstatic.com/D_NQ_NP_760710-MLA31659298494_082019-O.webp",
          ],
        },
        {
          name: "Ladrillos Comun Por 2 Unidades",
          description:
            "Somos Suministro de Obras, una empresa familiar con años de experiencia en la industria de la construcción, no solo te ofrecemos variedad de materiales, si no también, te ofrecemos un servicio personalizado para el diseño de tu nuevo hogar.",
          price: 68,
          stock: 100,
          content: 2,
          contentType: "Unidad (u)",
          images: [
            "https://http2.mlstatic.com/D_NQ_NP_721376-MLA44738847207_012021-O.webp",
          ],
        },
        {
          name: "Ladrillo Hueco 8x18x33x 6t. X 10",
          description:
            " Ladrillos cerámicos con 6 tubos huecos. Utilizados en las mamposteras no portantes para un ágil cerramiento y mayor aislación térmica.",
          price: 750,
          stock: 100,
          content: 10,
          contentType: "Unidad (u)",
          images: [
            "https://http2.mlstatic.com/D_NQ_NP_892918-MLA46363605477_062021-O.webp",
          ],
        },
        {
          name: "Piedra Partida De Construccion En Bolsa De 30 Kg Aproximado",
          description:
            "Piedra partida utilizada usualmente para hormigón armado en losas y/o carpetas de nivelación",
          price: 250,
          stock: 100,
          content: 30,
          contentType: "Kilo (k)",
  ...
  },
  {
    business: {
      name: "Iganacio",
      surname: "Rodriguez",
      password: "ignacio2021",
      email: "ignacio@rodriguez.com",
